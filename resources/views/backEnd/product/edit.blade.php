      ...
      <div class="card">
        <div class="card-body">
          <form action="{{route('products.update')}}" method="POST" class="row" data-parsley-validate="" enctype="multipart/form-data" name="editForm">
            ...
            <div class="col-sm-6">
              <div class="form-group mb-3">
                <label for="pre_booking" class="form-label">Partial Payment (Optional)</label>
                <input type="number" class="form-control" name="pre_booking" value="{{ $edit_data->pre_booking ?? '' }}" id="pre_booking" />                
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group mb-3">
                <label for="note" class="form-label">Product Note (Optional)</label>
                <input type="text" class="form-control" name="note" value="{{ $edit_data->note ?? '' }}" id="note" />
                @error('note')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
            ...
            <!-- col end -->
              ...
              <div class="col-sm-3 mb-3">
                  <div class="form-group">
                      ...
                      <label class="switch">
                          <input type="checkbox" value="1" name="isOffer" @if($edit_data->isOffer==1)checked @endif>
                          <span class="slider round"></span>
                      </label>
                      @error('isOffer')
                      <span class="invalid-feedback" role="alert">
