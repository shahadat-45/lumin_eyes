          ...
          <form action="{{route('products.store')}}" method="POST" class="row" data-parsley-validate="" enctype="multipart/form-data">
            ...
            <div class="col-sm-6">
              <div class="form-group mb-3">
                ...
                <input type="number" class="form-control" name="pre_booking" value="{{ old('pro_unit') }}" id="pre_booking" />                
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group mb-3">
                <label for="note" class="form-label">Product Note (Optional)</label>
                <input type="text" class="form-control" name="note" value="{{ old('pro_video') }}" id="note" />
                @error('note')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
