        ...
        <div class="checkout-summary-rows">
            ...
            <div class="checkout-summary-row">
                <div class="checkout-summary-main">
                    ...
                    <div class="checkout-summary-value"><span
                                class="checkout-summary-noline-value" id="discount">৳ {{ session('discount' , 0) }}</span>
                    </div>
                </div>
            </div>
        </div>
...
<div class="undefined checkout-order-total">
    <div class="checkout-order-total-row">
        ...
        <div class="checkout-order-total-fee">৳ <span id="total">{{ $subtotal + $shipping -  session('discount' , 0)}}</span><small
