...
//  Route::get('hot-deals', [FrontendController::class, 'hotdeals'])->name('hotdeals');
    ...
    Route::get('/cart-count', [FrontendController::class, 'cart_counts'])->name('cart.counts');
    ...
    Route::post('/contact-list/save', [FrontEndController::class, 'contactSave'])->name('contact.save');
    
    //coupon
    Route::post('/coupon/apply', [CouponController::class, 'apply'])->name('coupon.apply');
    Route::get('/show-cart-item' , [ShoppingController::class, 'showCart'])->name('cart.items');
    
    // cart route
    Route::post('cart/store', [ShoppingController::class, 'cart_store'])->name('cart.store');
    Route::post('cart/store2', [ShoppingController::class, 'cart_storeTwo'])->name('cart.storeTwo');
    ...
    Route::post('/wishlist/store' , [WishlistController::class, 'addToWishlist'])->name('addToWishlist');
    Route::get('/wishlist/delete' , [WishlistController::class, 'delete_wishlist'])->name('delete.wishlist');
    Route::post('/wishlist/to-cart' , [WishlistController::class, 'moveToCart'])->name('moveToCart');
...
Route::post('compare/store', [CompareController::class, 'store'])->name('addToCompare');
Route::get('/compare/delete' , [CompareController::class, 'delete_compare'])->name('delete.compare');
Route::post('/compare/to-cart' , [CompareController::class, 'moveToCart'])->name('compareToCart');
...
Route::view('/customer/checkout2','frontend.layouts.customer.checkout2')->name('checkout2');